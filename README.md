...
- Agregue una validacion, si el usuario ya compro un curso le saldra un aviso de que ya compro el curso, en vez del boton de compra. ademas agregue el boton para ver el contenido del curso.# Consolearn 🎓
