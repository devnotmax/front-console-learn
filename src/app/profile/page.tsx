    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 bg-[var(--background)] rounded-lg text-[var(--principal-text)] mb-8 mt-8 min-h-[70vh]">
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4 mb-6">
        ...
        <div className="text-center sm:text-left">
          ...
          <p className="text-[var(--secondary-text)] text-sm sm:text-base">@{userEmail}</p>
          <p className="text-[var(--secondary-text)] text-sm sm:text-base">{userPhone}</p>
        </div>
      </div>
...
// Aplica el HOC para proteger la página de perfil
